...
namespace HotelManagementSystemRoom
{
    public partial class View_Bill : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            workbook.SaveAs("C:\"Users\"Oladiti Tajudeen A\"Desktop\afeez\"output.xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
